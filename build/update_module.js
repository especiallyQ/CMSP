...
const solcBinList = [
    {
        name: 'v0.4.25.js',
        url: `https://TODOSITE/CMSP/download/solidity/wasm/v0.4.25.js`,
    },
    {
        name: 'v0.4.25-gm.js',
        url: `https://TODOSITE/CMSP/download/solidity/wasm/v0.4.25-gm.js`,
    },
    {
        name: 'v0.5.2.js',
        url: `https://TODOSITE/CMSP/download/solidity/wasm/v0.5.2.js`,
    },
    {
        name: 'v0.5.2-gm.js',
        url: `https://TODOSITE/CMSP/download/solidity/wasm/v0.5.2-gm.js`,
    },
    {
        name: 'v0.6.10.js',
        url: `https://TODOSITE/CMSP/download/solidity/wasm/v0.6.10.js`,
    },
    {
        name: 'v0.6.10-gm.js',
        url: `https://TODOSITE/CMSP/download/solidity/wasm/v0.6.10-gm.js`,
    }
];
