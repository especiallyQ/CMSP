    ...
    <div class="sidebar-wrapper">
        <div class="sidebar-content">
            <div class="image-flex justify-center center" v-if="menuShow">
                <span class="sidebar-header">CMSP</span>
                <span class="sidebar-contract-icon">
                    <i class="el-icon-caret-left font-color-aeb1b5"
                        @click="hideMune(true)"
            ...
            <div class="mini-sidebar-contract-icon" v-if="!menuShow">
                <i class="el-icon-caret-right font-color-aeb1b5"
                    ...
                    <el-submenu v-if="!item.leaf" :index="`${index}`" ref="ele" class="">
                        <template slot="title">
                            <div :style="{'padding-left': menuShow ? '13px':''}">
                                ...
                                <span
                                    :class="{'font-color-37eef2': activeIndex == index}">
                                    {{item.name}}
                                </span>
                            </div>
                        </template>
