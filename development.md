...
> 执行命令：
    ...
    git clone CMSP-Web.git

将代码放在你的工作目录，例如：D：\project

> 切换到项目目录：

    cd D:\project\CMSP-Web
...
> axios请求地址：
    ...
    overview请求url： /CMSP-Web/network/general/1

> mock.js地址：

    Mock.mock('/CMSP-Web/network/general/1',function (req,res) {     //url和上面axios相同
        return {
            "code":0,
            "message":"success",
            "data":{
